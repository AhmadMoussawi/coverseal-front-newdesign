export function generateTranslation(languages_code: string) {
  ...
  const jobs_template = {
    ...
    send_your_cv_text:
      '<p>Envoyez votre <em>CV</em> &amp; <em>lettre de motivation</em> &agrave; l&rsquo;adresse mail suivante : <a title="" href="mailto:jobs@coverseal-stage.com" target="_blank" rel="noopener">jobs@coverseal-stage.com</a></p>',
    no_job_offer_text:
